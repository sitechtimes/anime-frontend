...
export const useUserStore = defineStore("user", {
    ...
    actions: {
        ...
        async getAllGenre() {
            try {
                const endpoint =
                    "https://anime-backend-cuv2.onrender.com/genres";
                const headers = {
        ...
        async getAllAnime() {
            try {
                const endpoint =
                    "https://anime-backend-cuv2.onrender.com/anime/";
                const headers = {
                    "Content-Type": "application/json",
                };
        ...
        async updateAnime() {
            try {
                const endpoint =
                    "https://anime-backend-cuv2.onrender.com/updateAnime/";
                const headers = {
                    "Content-Type": "application/json",
        ...
        async getAllAwards() {
            try {
                const endpoint =
                    "https://anime-backend-cuv2.onrender.com/graphql/";
                const headers = {
                    "content-type": "application/json",
        ...
        async getOneAnime() {
            try {
                ...
                dataRes.animeGenre = dataRes.animeGenre.edges.map(
                    (edge: any) => {
                        return edge.node.genre;
                    }
                );

                dataRes.animeStudio = dataRes.animeStudio.edges.map(
                    (edge: any) => {
                        return edge.node.studio;
                    }
                );

                dataRes.animeAwards = dataRes.animeAwards.edges.map(
                    (edge: any) => {
                        return edge.node.id;
                    }
                );
            ...
            try {
                axios
                    ...
                    .then((res) => {
                        ...
                        axios
                            .get(
                                "https://anime-backend-cuv2.onrender.com/auth/user/",
                                {
                                    headers: {
