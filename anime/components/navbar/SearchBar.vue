...
export default {
	data: () => ({
		...
		showAnime: false,
		animes: [
			{ title: "One Punch Man", ageRating: "PG-13", stars: 8.5, releaseDate: "Oct 5, 2015" },
			...
			{
				title: "I Spent Hours of my Life Doing Spiral Abyss and all I got was an Extra 50 Primogems",
				ageRating: "E",
				stars: 9.89,
				releaseDate: "June 9, 2022",
			},
			{
				title: "Some Mid Isekai Anime",
				ageRating: "G",
				stars: 2.56,
				releaseDate: "Aug 19, 2021",
			},
			{
				title: "I went on a Field Trip Where I Touched Grass For the First Time in Years",
				ageRating: "PG-13",
				stars: 7.86,
				releaseDate: "Jan 17, 2012",
			},
			{ title: "The Pi in the Sky", ageRating: "G", stars: 9.9, releaseDate: "Mar 14, 1592" },
