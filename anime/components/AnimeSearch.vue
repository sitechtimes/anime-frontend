            ...
            <div class="allAnime-header">
                ...
                <div class="page-container">
                    <div class="page-number">
                        ...
                        <form
                            @submit.prevent="selectPage(userStore.pageNumber)"
                        >
                            <input
                                class="page-input"
                                type="number"
            ...
            <div class="allAnime-filter">
                ...
                <div class="allAnime-filterBox">
                    ...
                    >
                        ...
                        <option v-for="season in seasons" :value="season">
                            {{ season }}
                        </option>
                    </select>
                </div>
                ...
                <div class="allAnime-filterBox">
                    ...
                    >
                        ...
                        <option v-for="mtype in types" :value="mtype">
                            {{ mtype }}
                        </option>
                    </select>
                </div>
                ...
                <button class="button-clear" @click="clearAllFilter">
                    Clear All Filter
                </button>
            </div>
...
function calculateTotalPage() {
    totalPage.value = Math.ceil(
        userStore.filterAnime.length / animePerPage.value
    );
}
...
function filter(): animeRest[] {
    ...
    searchResult.forEach((anime: animeRest) => {
        ...
        if (
            (animeSeason.value == media_season.value ||
                media_season.value == "") &&
